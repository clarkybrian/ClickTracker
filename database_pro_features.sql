...
-- Utilise la table 'clicks' existante qui contient déjà toutes lesBEGIN
...
CREATE OR REPLACE VIEW clicks_pro AS
SELECT 
  c.*,
  l.short_code,
  l.title,
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'Pro subscription required for traffic source stats';
  END IF;
