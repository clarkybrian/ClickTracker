      ...
      <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <span className="text-3xl font-bold text-white">ClickTracker</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 flex items-center justify-center space-x-2"
                >
            ...
            <div className="space-y-8">
                  ...
                  {offices.map((office, index) => (
                    <div key={index} className="bg-white rounded-2xl p-6 shadow-lg">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h4 className="text-xl font-semibold text-gray-900 mb-2">{office.city}</h4>
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 text-white">
                <h4 className="text-2xl font-bold mb-6">Temps de réponse</h4>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <a
                key={index}
                href={faq.link}
                className="block p-6 bg-gray-50 rounded-2xl hover:bg-blue-50 hover:shadow-lg transition-all duration-300 group"
              >
