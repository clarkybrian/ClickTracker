-- Supprimer les anciennes fonctions et les recréer avec 'pro' et 'business'

-- Supprimer les anciennes fonctions
DROP FUNCTION IF EXISTS get_geographic_stats(uuid, uuid);
DROP FUNCTION IF EXISTS get_device_stats(uuid, uuid);
DROP FUNCTION IF EXISTS get_traffic_sources(uuid, uuid);
DROP FUNCTION IF EXISTS create_data_export(uuid, text);

-- Recréer les fonctions avec 'pro' et 'business'
